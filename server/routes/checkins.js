  ...
  try {
    ...
    try {
      ...
      if (tenant?.phone) {
        ...
        const welcomeMsg = `Welcome to Anahuac RV Park! We're glad you're here.\n\nLot: ${lot_id}\nContact: 409-267-6603 | anrvpark.com${wifiLine}\nYOUR GUEST PORTAL - Your park, in your pocket.\n\nThe portal puts everything you need in one place, 24/7:\n- Pay rent and view your balance in seconds\n- See invoices, payment history, and account credit\n- Submit and track maintenance requests\n- Message the office anytime, anywhere\n- Read park announcements and weather alerts\n- Join community chats with your neighbors\n- Browse local guides: dining, fishing, birding, parks\n- Share photos from the garden, fishing, and hunting\n\nGet in:\n${APP_URL}/portal.html\n\nLog in with your lot number and last name, then set a 4-digit PIN. Add to your home screen for one-tap access from your phone.\n\nWelcome home!`;
